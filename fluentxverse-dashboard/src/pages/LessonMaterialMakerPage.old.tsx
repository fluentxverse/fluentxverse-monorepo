...
const COURSE_TEMPLATES: TemplateInfo[] = [
  ...
  // Speaking Starter - Reading Grade 1
  {
    ...
    course: 'Speaking Starter',
    category: 'Speaking',
    icon: '�',
    description: 'Structured ESL lessons with Korean translations. Speaking-focused curriculum for beginner English learners.',
    sections: 5,
...
// Speaking Starter Template - Redesigned for beginner ESL with Korean support
const createSpeakingStarterDraft = (): LessonMaterialDraft => ({
  ...
  header: {
    backgroundImage: '',
    overlayColor: '#7c3aedcc',
    levelBadge: 'SPEAKING STARTER',
    chapterLabel: 'Unit 1 | Lesson 1',
    lessonLabel: 'Self-Introduction',
    goalText: 'I can introduce myself in English',
    goalSubtext: '영어로 자기소개를 할 수 있다',
  },
  sections: [
    // Section 1: Today's Key Expressions
    {
      id: 'ss-expressions',
      sectionNumber: 1,
      sectionTitle: 'KEY EXPRESSIONS',
      sectionType: 'vocabulary',
      explanationEn: 'Learn these essential phrases for introducing yourself.',
      explanationJp: '자기소개에 필요한 핵심 표현을 배웁니다.',
      sectionImage: '',
      importantNote: '',
      copyTemplate: '',
      stepTitle: 'Listen and Repeat',
      instructionEn: 'Practice saying each expression after your tutor.',
      instructionJp: '선생님을 따라 각 표현을 연습하세요.',
      vocabCards: [
        { id: 'v1', image: '', wordEn: 'I am [name].', wordJp: '저는 [이름]입니다.' },
        { id: 'v2', image: '', wordEn: 'My name is [name].', wordJp: '제 이름은 [이름]입니다.' },
        { id: 'v3', image: '', wordEn: 'I\'m from [place].', wordJp: '저는 [장소] 출신입니다.' },
        { id: 'v4', image: '', wordEn: 'I\'m [age] years old.', wordJp: '저는 [나이]살입니다.' },
        { id: 'v5', image: '', wordEn: 'I\'m a [job/student].', wordJp: '저는 [직업/학생]입니다.' },
        { id: 'v6', image: '', wordEn: 'I like [hobby].', wordJp: '저는 [취미]를 좋아합니다.' },
      ],
      sidebarTitle: 'EXPRESSIONS',
      sidebarSubtitle: '5 min',
      lessonGoalTitle: 'Tutor Guide',
      lessonGoalSteps: [
        { id: 's1', instruction: 'Greet the student and introduce the lesson goal.' },
        { id: 's2', instruction: 'Read each expression clearly and have the student repeat.' },
        { id: 's3', instruction: 'Correct pronunciation gently using repetition.' },
        { id: 's4', instruction: 'Ask the student to use 2-3 expressions about themselves.' },
      ],
    },
    // Section 2: Reading Comprehension
    {
      ...
      sectionType: 'reading',
      explanationEn: 'Read the self-introduction and answer questions.',
      explanationJp: '자기소개를 읽고 질문에 답하세요.',
      sectionImage: '',
      importantNote: '',
      copyTemplate: '',
      stepTitle: 'Meet Riku',
      instructionEn: 'Read about your classmate.',
      instructionJp: '동급생에 대해 읽어보세요.',
      readingText: 'Hello! I am Riku Yamazaki. I\'m from Japan. I\'m 13 years old. I\'m a student. I like animals and apple pie.',
      readingQuestions: [
        { id: 'q1', questionEn: 'What is his name?', answer: 'Riku Yamazaki' },
        { id: 'q2', questionEn: 'Where is he from?', answer: 'Japan' },
        { id: 'q3', questionEn: 'What does he like?', answer: 'Animals and apple pie' },
      ],
      sidebarTitle: 'READING',
      sidebarSubtitle: '5 min',
      lessonGoalTitle: 'Tutor Guide',
      lessonGoalSteps: [
        { id: 's1', instruction: 'Have the student read the passage aloud.' },
        { id: 's2', instruction: 'Help with pronunciation as needed.' },
        { id: 's3', instruction: 'Ask comprehension questions one by one.' },
        { id: 's4', instruction: 'Encourage complete sentence answers.' },
      ],
    },
    // Section 3: Grammar Practice
    {
      ...
      sectionType: 'practice',
      explanationEn: 'Choose the correct word to complete each sentence.',
      explanationJp: '각 문장을 완성할 올바른 단어를 선택하세요.',
      sectionImage: '',
      importantNote: '',
      copyTemplate: '',
      stepTitle: 'Fill in the Blank',
      instructionEn: 'Select the correct answer.',
      instructionJp: '정답을 선택하세요.',
      practiceItems: [
        { id: 'p1', question: '(I / My) name is Sara.', answer: 'My' },
        { id: 'p2', question: 'I\'m (a / an) student.', answer: 'a' },
        { id: 'p3', question: 'I\'m (a / from) Korea.', answer: 'from' },
        { id: 'p4', question: '(I\'m / My) 12 years old.', answer: 'I\'m' },
        { id: 'p5', question: 'I (like / likes) music.', answer: 'like' },
      ],
      sidebarTitle: 'PRACTICE',
      sidebarSubtitle: '5 min',
      lessonGoalTitle: 'Tutor Guide',
      lessonGoalSteps: [
        { id: 's1', instruction: 'Explain the task: choose the correct word.' },
        { id: 's2', instruction: 'Have student read each complete sentence aloud.' },
        { id: 's3', instruction: 'Confirm or correct their answer.' },
        { id: 's4', instruction: 'Briefly explain why if they make mistakes.' },
      ],
    },
    // Section 4: Speaking Task
    {
      id: 'ss-speaking',
      sectionNumber: 4,
      sectionTitle: 'SPEAKING',
      sectionType: 'dialogue',
      explanationEn: 'Practice introducing yourself in a conversation.',
      explanationJp: '대화에서 자기소개를 연습하세요.',
      sectionImage: '',
      importantNote: '',
      copyTemplate: '',
      stepTitle: 'Role Play',
      instructionEn: 'You are a new student at school. Introduce yourself to your classmate.',
      instructionJp: '당신은 학교의 새 학생입니다. 동급생에게 자기소개를 하세요.',
      dialogueImage: '',
      dialogueLines: [
        { id: 'd1', speaker: 'Classmate', lineEn: 'Hi! What\'s your name?' },
        { id: 'd2', speaker: 'You', lineEn: '(Introduce yourself)' },
        { id: 'd3', speaker: 'Classmate', lineEn: 'Where are you from?' },
        { id: 'd4', speaker: 'You', lineEn: '(Answer)' },
        { id: 'd5', speaker: 'Classmate', lineEn: 'What do you like?' },
        { id: 'd6', speaker: 'You', lineEn: '(Answer)' },
        { id: 'd7', speaker: 'Classmate', lineEn: 'Nice to meet you!' },
      ],
      sidebarTitle: 'SPEAKING',
      sidebarSubtitle: '5 min',
      lessonGoalTitle: 'Tutor Guide',
      lessonGoalSteps: [
        { id: 's1', instruction: 'Explain the role play scenario.' },
        { id: 's2', instruction: 'Play the role of the classmate.' },
        { id: 's3', instruction: 'Encourage using today\'s expressions.' },
        { id: 's4', instruction: 'Give positive feedback after completion.' },
      ],
    },
    // Section 5: Review and Self-Evaluation
    {
      id: 'ss-review',
      sectionNumber: 5,
      sectionTitle: 'REVIEW',
      sectionType: 'feedback',
      explanationEn: 'Let\'s review what you learned today.',
      explanationJp: '오늘 배운 내용을 복습합니다.',
      sectionImage: '',
      importantNote: '',
      copyTemplate: '',
      feedbackRubric: [
        { score: 5, label: 'Excellent', description: 'Used expressions confidently and accurately' },
        { score: 4, label: 'Good', description: 'Used most expressions correctly' },
        { score: 3, label: 'OK', description: 'Able to respond with some help' },
        { score: 2, label: 'Needs Practice', description: 'Understood but needed guidance' },
        { score: 1, label: 'Keep Trying', description: 'Needs more practice' },
      ],
      feedbackCategories: [
        { id: 'fc1', title: 'Expressions', titleJp: '표현', descJp: '오늘의 표현' },
        { id: 'fc2', title: 'Vocabulary', titleJp: '어휘', descJp: '새 단어' },
        { id: 'fc3', title: 'Pronunciation', titleJp: '발음', descJp: '발음 연습' },
      ],
      feedbackTemplate: 'Today you learned:\n- I am / My name is\n- I\'m from\n- I like\n\nGreat job! Keep practicing!',
      sidebarTitle: 'REVIEW',
      sidebarSubtitle: '3 min',
      lessonGoalTitle: 'Tutor Guide',
      lessonGoalSteps: [
        { id: 's1', instruction: 'Review the lesson goal with the student.' },
        { id: 's2', instruction: 'Ask: "Can you introduce yourself now?"' },
        { id: 's3', instruction: 'Have student self-evaluate using the rubric.' },
        { id: 's4', instruction: 'Give encouragement and say goodbye.' },
      ],
    },
  ],
  vocabulary: [],
...
export default function LessonMaterialMakerPage() {
  ...
  const getEffectiveUrlParams = (): URLSearchParams => {
    try {
      const url = new URL(window.location.href);
      const params = new URLSearchParams(url.search);

      // Support hash-based routing where query params live in the hash.
      // Examples:
      // - /#/lesson-material-maker?src=...&preview=1
      // - /lesson-material-maker#/?src=...&preview=1
      const hash = url.hash || '';
  ...
  const [isLockedPreviewFromUrl] = useState<boolean>(() => {
    const params = getEffectiveUrlParams();
    return (
      params.has('src') ||
      params.has('previewToken') ||
      params.get('preview') === '1' ||
      params.get('studentView') === '1'
    );
  });

  // Initialize preview mode based on URL parameters (if src/previewToken/preview/studentView is present, start in preview mode)
  const [isPreviewMode, setIsPreviewMode] = useState(() => isLockedPreviewFromUrl);
  ...
  const [previewTokenFromUrl] = useState<string | null>(() => {
    try {
      return getEffectiveUrlParams().get('previewToken');
    } catch {
      return null;
    }
  });
  const [previewSrcFromUrl] = useState<string | null>(() => {
    try {
      return getEffectiveUrlParams().get('src');
    } catch {
      return null;
    }
  });
  const [shouldAutoPrintFromUrl] = useState<boolean>(() => {
    try {
      return getEffectiveUrlParams().get('print') === '1';
    } catch {
      return false;
    }
  });
  const [studentViewFromUrl] = useState<boolean>(() => {
    try {
      return getEffectiveUrlParams().get('studentView') === '1';
    } catch {
      return false;
    }
  });
  ...
  useEffect(() => {
    if (!isLockedPreviewFromUrl) return;
    setIsPreviewMode(true);
  }, [isLockedPreviewFromUrl]);

  useEffect(() => {
    if (!studentViewFromUrl) return;
    setMaterialViewMode('student');
  }, [studentViewFromUrl]);
  ...
  useEffect(() => {
    ...
    const run = async () => {
      try {
        ...
        // Preserve studentView and preview parameters when redirecting
        if (studentViewFromUrl) {
          url.searchParams.set('studentView', '1');
        }
        // Always add preview=1 when loading from src (external source)
    ...
    void run();
  }, [previewTokenFromUrl, previewSrcFromUrl, studentViewFromUrl]);
  ...
  const handleOpenPreview = useCallback(() => {
    ...
    try {
      const url = new URL(window.location.href);
      url.searchParams.set('previewToken', token);
      // Always set preview=1 to ensure it opens in preview mode
      url.searchParams.set('preview', '1');
      window.open(url.toString(), '_blank');
    } catch (err) {
      console.error('Failed to open preview tab:', err);
    ...
    <div className={`lm-builder ${isFullscreen ? 'lm-builder-fullscreen' : ''} ${isPreviewMode ? 'lm-preview-mode' : ''} ${courseClass}`}>
      {!previewTokenFromUrl && (
        <>
          ...
          {/* Toggle Preview Mode (disabled for locked preview URLs) */}
          {currentEditingLesson && !isLockedPreviewFromUrl && (
            <button
              type="button"
                  ...
                  {section.sectionType !== 'question' && section.sectionType !== 'trivia' && section.sectionType !== 'challenge2' &&
                   ...
                   !(section.sectionType === 'practice' && !section.sectionTitle) && (
                    <div className="lm-section-title-row">
                      <span className="lm-section-number"><span className="lm-section-number-text">{section.sectionNumber}</span></span>
                      <span
