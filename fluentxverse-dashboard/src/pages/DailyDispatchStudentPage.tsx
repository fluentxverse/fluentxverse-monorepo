/**
 * DailyDispatchStudentPage
 * Student-facing view for Daily Dispatch news article lessons
 * Same as preview but without tutor instructions and answer keys
 */
...
import './DailyDispatchStudentPage.css';

export default function DailyDispatchStudentPage() {
                ...
                {archives.map((archive, i) => (
                  <li key={i}>
                    <a 
                      ...
                      onClick={(e) => {
                        e.preventDefault();
                        location.route(`/daily-dispatch/student/archives/${encodeURIComponent(archive.month)}`);
                      }}
                    >
                      {archive.month}
                    </a>
